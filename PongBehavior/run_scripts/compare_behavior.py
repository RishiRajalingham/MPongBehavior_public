...
model_dat_fn = '/om/user/rishir/lib/PongRnn/fig/rnn_res/perc_model_res_random_seed_lt_50.pkl'
...
save_path = '/om/user/rishir/lib/MentalPong/dat/'
comparer = BC.BehavioralComparer( model_dat_fn=model_dat_fn,
                                  ...
                                  prefix='')
comparer.run_all(recompute_consistency=False)
