...
model_dat_fn = '/om/user/rishir/lib/PongRnn/fig/rnn_res_regularized/perc_model_res_random_seed_lt_50.pkl'
...
save_path = '/om/user/rishir/lib/MentalPong/dat_regularized/'
