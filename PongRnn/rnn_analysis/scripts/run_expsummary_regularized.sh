...
indirpath="/om/user/rishir/lib/PongRnn/dat/rnn_res_regularized/"
outdirpath="/om/user/rishir/lib/PongRnn/fig/rnn_res_regularized/"

python $pyfn --results_path $indirpath --fig_out_path $outdirpath --update_only False